...
const sampleData = [
    { skuName: 'Protein Bar 100g', sales: 93132.12, outOfStock: 1.68, totalInventory: 931.9, averageRank: 3.2, estTraffic: 12303, estImpressions: 25005, ci: 1.5 },
    { skuName: 'Choco Bar 100g', sales: 8526.32, outOfStock: 6.79, totalInventory: 679, averageRank: 7, estTraffic: 3005, estImpressions: 4231, ci: 2.1 },
    ...
    return (
        <div className="w-full bg-gray-100 p-4">
            <div className="flex items-center justify-between mb-4 ">
                <div>
                    <h2 className="text-xl font-semibold">SKU level data</h2>
                    <p className="text-gray-600 text-xs">Analytics for all your SKUs</p>
                </div>
            ...
            <div className='bg-white shadow-md rounded-md py-2 overflow-x-auto hide-scrollbar'>
                <Table>
                    <TableHeader>
                        <TableRow>
